...
const FeedbackCard = ({
    ...
    <motion.div
        ...
        className='bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full border border-white/5 backdrop-blur-sm'
    >
...
const Feedbacks = () => {
    return (
        <div className={`mt-12 bg-black-100 rounded-[20px] overflow-hidden`}>
            <div
                className={`bg-tertiary rounded-2xl min-h-[300px] p-8 sm:px-16 px-6 pt-12`}
            >
                <motion.div variants={textVariant()}>
                    <p className="sm:text-[18px] text-[14px] text-secondary uppercase tracking-[4px] font-medium">What others say</p>
